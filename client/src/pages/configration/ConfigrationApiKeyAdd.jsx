...
const ConfigrationApiKeyAdd = () => {
    ...
    const handleConfigRuleId = (e) => {
        const merchant = merchantdata.find((m) => m.id === parseInt(e.target.value));
                                ...
                                <div className="ps-3">
                                    <nav aria-label="breadcrumb">
                                        <ol className="breadcrumb mb-0 p-0">
                                            ...
                                            <li className="breadcrumb-item active" aria-current="page"> Api Key Add</li>
                                        </ol>
                                    </nav>
                                </div>
                                ...
                                <div className="card radius-10">
                                    <div className="card-body p-4">
                                        <div className="row mb-3">
                                            <label htmlFor="input46" className="col-sm-3 col-form-label">Select Merchant</label>
                                    ...
                                    <div className="card-body p-4">
                                        ...
                                        <div className="row mb-3">
                                            <label htmlFor="input42" className="col-sm-3 col-form-label">Key</label>
                                           ...
                                           <center> {errors.key && <div style={{ color: "red" }}>{errors.key}</div>}</center>
                                        </div>
                                        ...
                                        <div className="row mb-3">
                                            ...
                                            <center>{errors.password && <div style={{ color: "red" }}>{errors.password}</div>}</center>
