...
--
-- Database: `futuregen_crypto_payment_db`
--
...
CREATE TABLE `bulk_address` (
  ...
  `block_status` int NOT NULL DEFAULT '0' COMMENT '0=unblock,1=block',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `deposit_request` (
  `id` int NOT NULL,
  `depositID` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `user_id` int DEFAULT NULL,
  `merchant_id` int DEFAULT NULL,
  `deposit_amount` double(10,2) DEFAULT NULL,
  `receivable_amount` double(10,2) DEFAULT NULL,
  `payment_method` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `to_crypto_wallet_address` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `trxId` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `depscription` text COLLATE utf8mb4_unicode_ci,
  `wallet_address` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` int DEFAULT NULL COMMENT '0=Review,2=Reject,1=Approved',
...
CREATE TABLE `global_wallet_address` (
  ...
  `status` int DEFAULT '1',
  `lock_unlock` int NOT NULL COMMENT '1=lock,0=unlock',
...
CREATE TABLE `merchant_request` (
  ...
  `password` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `status` int DEFAULT '0' COMMENT '1=approved\r\n0=not approved',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `posts` (
  ...
  `entry_by` int DEFAULT NULL,
  `thumnail_img` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` int DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `setting` (
  `id` int NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `deposit_service_charge` int DEFAULT NULL COMMENT '%',
  `convert_php_amt` float DEFAULT NULL,
  `withdraw_service_charge` int DEFAULT NULL COMMENT '%',
  `withdraw_minimum_amount` int DEFAULT NULL,
  `withdraw_maximum_amount` int DEFAULT NULL,
  `minimum_trade_amount` int DEFAULT NULL,
  `minimum_purchages_amt` int DEFAULT NULL,
  `minimum_deposit_amount` int DEFAULT NULL,
  `trade_fee` int DEFAULT NULL COMMENT '%',
  ...
  `status` int NOT NULL,
  `admin_photo` varchar(244) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `pphoto` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `reffer_bonus` int DEFAULT NULL,
  `maximum_supply` double(10,2) DEFAULT NULL,
  `total_supply` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `openinig_balance_comments` mediumtext COLLATE utf8mb4_unicode_ci,
  ...
  `linkdinlink` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `instragramlink` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `store_policy` longtext COLLATE utf8mb4_unicode_ci,
  `crypto_wallet_address` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `master_pass_acc_no` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `website` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `telegram` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `register_bonus` int DEFAULT NULL,
  ...
  `level_1_bonus` int DEFAULT NULL,
  `level_2_bonus` int DEFAULT NULL,
  `level_3_bonus` int DEFAULT NULL,
  ...
  `maximum_supply_level` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `total_supply_level` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `liquidity_total_supply` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `beganing_price` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `circlation` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `users` (
  `id` bigint UNSIGNED NOT NULL,
  `fg_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fg_wallet_address` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `show_password` varchar(225) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `github` varchar(225) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `telegram` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `whtsapp` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `remember_token` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `entry_by` int DEFAULT NULL,
  `register_ip` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `lastlogin_ip` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `lastlogin_country` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `lastlogin_datetime` datetime DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `status` int DEFAULT '0',
  `logged_out` int DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
